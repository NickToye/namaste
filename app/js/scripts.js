...
+function ($) {
  ...
  Carousel.prototype.getItemIndex = function (item) {
    this.$items = item.parent().children('.carousel__item')
  ...
  Carousel.prototype.to = function (pos) {
    var that        = this
    var activeIndex = this.getItemIndex(this.$active = this.$element.find('.carousel__item.active'))
...
+function ($) {
  ...
  Dropdown.prototype.toggle = function (e) {
    ...
    if (!isActive) {
      if ('ontouchstart' in document.documentElement && !$parent.closest('.navbar__nav').length) {
